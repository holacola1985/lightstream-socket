...
Socket.prototype._setBoundingBox = function (bounding_box) {
...
Socket.prototype.initializeBoundingBox = function initializeBoundingBox(bounding_box) {
  ...
  this._sendBoundingBoxInitialized(this.bounding_box, this.type, this.socket);
};
...
Socket.prototype._sendBoundingBoxInitialized = function _sendBoundingBoxInitialized() {
  this._sendEvent('bounding_box_initialized');
};

Socket.prototype._sendEvent = function _sendEvent(event) {
